...
const unfundedGamesString = `A total of ${totalContributions.toLocaleString()} has been raised for games. Curently, 7 games remain unfunded. We need your help to fund these amazing games!'`;
